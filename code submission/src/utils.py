...
realrech_prior1 = dists.StructDist({'v0f': dists.Normal(0,.1),
...
realrech_prior2 = dists.StructDist({'v0f': dists.Normal(0,1),
                             'v1f': dists.Normal(0,1),
                             'v2f': dists.Normal(0,1),
                             'v3f': dists.Normal(0,1),
                             'wf': dists.Normal(0,1),
...
realrech_prior3 = dists.StructDist({'v0f': dists.Normal(0,10),
                             'v1f': dists.Normal(0,10),
                             'v2f': dists.Normal(0,10),
                             'v3f': dists.Normal(0,10),
                             'wf': dists.Normal(0,10),
                             'bf': dists.Normal(0,10),
                             'v0i': dists.Normal(0,10),
                             'v1i': dists.Normal(0,10),
                             'v2i': dists.Normal(0,10),
                             'v3i': dists.Normal(0,10),
                             'wi': dists.Normal(0,10),
                             'bi': dists.Normal(0,10),
                             'v0o': dists.Normal(0,10),
                             'v1o': dists.Normal(0,10),
                             'v2o': dists.Normal(0,10),
                             'v3o': dists.Normal(0,10),
                             'wo': dists.Normal(0,10),
                             'bo': dists.Normal(0,10), 
                             'v0d': dists.Normal(0,10),
                             'v1d': dists.Normal(0,10),
                             'v2d': dists.Normal(0,10),
                             'v3d': dists.Normal(0,10),
                             'wd': dists.Normal(0,10),
                             'bd': dists.Normal(0,10),  
                             'beta0': dists.Gamma(1,.1),
                             'beta1': dists.Gamma(1,10),
                             'beta': dists.Uniform(0,1),                                     
                             'gamma': dists.Beta(2,5),
